...
const config = require('./config'); // Configuration file that holds botToken API key.

const bot = new Telegraf(config.telegramToken);    // Let's instantiate a bot using our token.
